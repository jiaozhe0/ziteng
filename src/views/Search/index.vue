<template>
  <div class="search">
  	<search @search="_getSearchList" path="/index"></search>
    <div class="content">
    	...
    	<button @click='_delet' class='center-block delet-btn'>
    	<div class="deleteIcon"></div>清空历史</button>
    </div>
  </div>
</template>
...
.delet-btn{
	position: relative;
			...
			.deleteIcon{
				...
				.bg-view-image('Search/delete-icon');
			}
		}
</style>